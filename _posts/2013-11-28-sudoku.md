...
First, we need a better representation of `board`, ideally another matrix of numbers. The following clever Scala code creates a vector with the known numbers of the game, where unknown cells are indicates by negative numbers:
